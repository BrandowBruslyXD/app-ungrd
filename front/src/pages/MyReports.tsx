  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 lg:py-12 animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Mis Reportes</h1>
          <p className="mt-1 text-sm text-slate-500">
            Seguimiento de todas tus emergencias reportadas
          </p>
        </div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                ...
                <span className={`inline-flex items-center gap-1 rounded-full px-1.5 py-0.5 text-xs font-medium ${
                  ...
                  {report.reportType === 'testigo' ? 'Testigo' : 'Afectado'}
                </span>
            ...
            <div className="hidden shrink-0 text-right sm:block">
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                {report.timeline.length} actualizaciones
              </p>
            </div>
