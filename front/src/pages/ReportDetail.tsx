  ...
  if (!report) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        <p className="text-lg font-semibold text-slate-800">Reporte no encontrado</p>
        <p className="mt-2 text-sm text-slate-500">El reporte {id} no existe o fue eliminado.</p>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 lg:py-12 animate-fade-in">
      ...
      <div className="card p-4 sm:p-6">
        ...
        <div className="mt-6 pt-5 border-t border-slate-100">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium text-slate-700">Progreso del ciclo</p>
        ...
        {report.satelliteVerified && (
          <div className="card p-5 border-l-4 border-l-emerald-400">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-emerald-700">Verificado por satélite</p>
            </div>
            <p className="text-sm text-slate-600">
              Datos de NASA/Copernicus confirman la situación reportada en esta zona.
            </p>
            <button className="mt-3 flex items-center gap-1 text-xs font-medium text-emerald-600 hover:text-emerald-700">
              Ver datos satelitales <ExternalLink className="h-3 w-3" />
            </button>
          </div>
        )}
        ...
        {report.publicSpending && (
          <div className="card p-5 border-l-4 border-l-gold-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-gold-800">Gasto público</p>
            </div>
            <p className="text-2xl font-bold text-slate-800">
              {formatCurrency(report.publicSpending)}
            </p>
            <p className="text-xs text-slate-500 mt-1">
              Destinados por la alcaldía para atender esta emergencia
            </p>
            <button className="mt-3 flex items-center gap-1 text-xs font-medium text-gold-700 hover:text-gold-800">
      ...
      <div className="mt-6 sm:mt-8">
        <h2 className="text-base font-bold text-slate-800 mb-3 sm:text-lg sm:mb-5">Historial del reporte</h2>
        <div className="card p-4 sm:p-6">
