        ...
        >
          <dl className="space-y-1.5">
            <div className="flex gap-2">
              ...
              <dd className="min-w-0 break-all font-mono text-sm">{paquete.correoDestino}</dd>
            </div>
            <div className="flex gap-2">
          ...
          <p className="mt-3 text-sm font-semibold text-ungrd-800">{t('paquete.simuladoEtiqueta')}</p>
        </DialogoConfirmacion>
      )}
    </div>
  );
...
function PaqueteNoEncontrado({ codigo }: { codigo: string | undefined }) {
  ...
  return (
    <div className="py-16">
      {/* Columna estrecha a propósito: es un mensaje corto y centrado, no una pantalla de datos. */}
      <div className="mx-auto max-w-xl text-center">
        ...
        <h1 className="text-xl font-bold text-slate-900">{t('paquete.noEncontradoTitulo')}</h1>
