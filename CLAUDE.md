...
| [docs/CANALES-CONVERSACIONALES.md](docs/CANALES-CONVERSACIONALES.md) | Qué plataformas reciben WhatsApp y las llamadas, qué API consume cada una y dónde escriben |
